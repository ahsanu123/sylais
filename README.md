...
- [whisper candle implementation sample](https://huggingface.co/spaces/lmz/candle-whisper)
- [llama2 candle implementation sample](https://huggingface.co/spaces/lmz/candle-llama2)
- [piper-rs](https://github.com/thewh1teagle/piper-rs)
- [whisper.cpp](https://github.com/ggml-org/whisper.cpp)
- [llama.cpp](https://github.com/ggml-org/llama.cpp)
- [piper](https://github.com/rhasspy/piper)
- [SoundFlow](https://github.com/LSXPrime/SoundFlow)
- [whisper onnx](https://k2-fsa.github.io/sherpa/onnx/pretrained_models/whisper/export-onnx.html)
- [rust ort sample](https://github.com/pykeio/ort/tree/main/examples)
- [candle onnx sample with squezenet](https://github.com/huggingface/candle/blob/main/candle-examples/examples/onnx/main.rs)
